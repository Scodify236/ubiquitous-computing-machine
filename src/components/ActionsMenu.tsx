        ...
        <Show when={!getSaved('kidsMode_Watch On Button')}>
          {
            isWatchOnraag() ?
              <li tabindex={6} on:click={() => {
                close();
                render(WatchOnraag, document.body);
              }}>
                <i class="ri-youtube-line"></i>Watch on Raag Heaven
              </li>
              :
              <li tabindex={6} on:click={() => {
                close();
